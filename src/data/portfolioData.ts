...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'samanea-wellness-resort',
    category: 'Web Development',
    shortDescription: 'A premium Wellness Resort website built using Webflow.',
    description: 'Developed for a client, this platform streamlines fine-dining operations, reservations, and interactive digital menus. Built with Webflow on the frontend, using Figma for prototyping. Handled responsibilities from wireframing to frontend component construction and API integration.',
    technologies: ['Webflow', 'Figma', 'Photoshop', 'Notion'],
    image: '/assets/samanea.png',
    featured: true,
    liveUrl: 'https://www.samanea-wellnessresort.com/',
  },
  {
    id: 3,
    title: 'Komi',
    slug: 'komi',
    category: 'Web Development',
    shortDescription: 'A korean style online shop based in Phnom Penh, Cambodia.',
    description: 'Developed for a client, this platform streamlines online shopping operations for selling korean style clothes . Built with HTML, CSS and JavaScript on the frontend, using Bootstrap for a premium user experience, and Figma for prototyping. Handled responsibilities from wireframing to frontend component construction.',
    technologies: ['HTML', 'CSS', 'JavaScript', 'Bootstrap', 'Figma', 'Notion', 'GitHub'],
    image: '/assets/komi.png',
    featured: true,
    liveUrl: 'https://komi-olive.vercel.app/',
    repositoryUrl: 'https://github.com/sornsomavatey/komi.git',
  },
  {
    id: 4,
    title: 'Invoxia',
    ...
    shortDescription: 'Automated invoice processing system using OCR and AI.',
    description: 'Invoxia is an automated invoice-processing system built on OCR and a structured data-extraction pipeline. It eliminates manual scanning, reviewing, and data entry errors by providing a fully automated workflow: invoice upload, image preprocessing (resizing, denoising, contrast adjustment), text extraction with a fine‑tuned TrOCR model, conversion to structured JSON, validation, aggregation for total spending, and secure storage for reporting and future analysis.',
    technologies: ['Python', 'OCR', 'TrOCR', 'FastAPI', 'Docker', 'PostgreSQL', 'React', 'Figma'],
    image: '/assets/invoxia.png',
    featured: true,
    liveUrl: 'https://invoxiainc.onrender.com/analytic',
    repositoryUrl: 'https://github.com/sornsomavatey/Invoxia.git',
  },
  {
    id: 5,
